        ...
        BrowseEmployees: $defineScreen(BrowseEmployees, [
            {
                ...
                createQuery: function (Search) {
                    return this.dataWorkspace.ApplicationData.Employees.filter("((" + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", FirstName)") + " or " + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", LastName)") + ") or " + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", UserName)") + ") or " + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", Email)") + "");
                }
            },
        ...
        BrowseHazardTypes: $defineScreen(BrowseHazardTypes, [
            {
                ...
                createQuery: function (Search) {
                    return this.dataWorkspace.ApplicationData.HazardTypes.filter("" + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", HazardTypeDescription)") + "");
                }
            },
            { name: "Search", kind: "local", type: String }
        ], [
        ...
        BrowseMyRiskAssessmentReviews: $defineScreen(BrowseMyRiskAssessmentReviews, [
            {
                ...
                createQuery: function (Search) {
                    return this.dataWorkspace.ApplicationData.MyRiskAssessmentReviews().filter("(" + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", RiskAssessment/ReferenceNumber)") + " or " + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", RiskAssessment/RiskAssessmentTitle)") + ") or " + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", Outcome)") + "").expand("RiskAssessment");
                }
            },
            { name: "Search", kind: "local", type: String }
        ], [
        ...
        BrowseMyRiskAssessments: $defineScreen(BrowseMyRiskAssessments, [
            {
                ...
                createQuery: function (Search) {
                    return this.dataWorkspace.ApplicationData.MyRiskAssessments().filter("((" + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", ReferenceNumber)") + " or " + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", RiskAssessmentTitle)") + ") or " + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", RiskType/TypeOfRisk)") + ") or " + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", RiskAssessmentStatus/Status)") + "").expand("RiskType").expand("RiskAssessmentStatus");
                }
            },
            { name: "Search", kind: "local", type: String }
        ], [
        ...
        BrowseOverdueRiskAssessmentReviews: $defineScreen(BrowseOverdueRiskAssessmentReviews, [
            {
                ...
                createQuery: function (Search) {
                    return this.dataWorkspace.ApplicationData.OverdueRiskAssessmentReviews().filter("((" + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", RiskAssessment/ReferenceNumber)") + " or " + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", RiskAssessment/RiskAssessmentTitle)") + ") or " + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", RiskAssessmentReviewer/Employee/LastName)") + ") or " + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", RiskAssessmentReviewer/Employee/FirstName)") + "").expand("RiskAssessment").expand("RiskAssessmentReviewer").expand("RiskAssessmentReviewer.Employee");
                }
            },
            { name: "Search", kind: "local", type: String }
        ], [
        ...
        BrowseRiskAssessments: $defineScreen(BrowseRiskAssessments, [
            {
                ...
                createQuery: function (Search) {
                    return this.dataWorkspace.ApplicationData.RiskAssessments.filter("((" + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", ReferenceNumber)") + " or " + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", RiskAssessmentTitle)") + ") or " + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", RiskType/TypeOfRisk)") + ") or " + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", RiskAssessmentStatus/Status)") + "").expand("RiskType").expand("RiskAssessmentStatus");
                }
            },
            { name: "Search", kind: "local", type: String }
        ], [
        ...
        BrowseRiskAssessmentStatuses: $defineScreen(BrowseRiskAssessmentStatuses, [
            {
                ...
                createQuery: function (Search) {
                    return this.dataWorkspace.ApplicationData.RiskAssessmentStatuses.filter("" + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", Status)") + "");
                }
            },
            { name: "Search", kind: "local", type: String }
        ], [
        ...
        BrowseRiskAssessors: $defineScreen(BrowseRiskAssessors, [
            {
                ...
                createQuery: function (Search) {
                    return this.dataWorkspace.ApplicationData.RiskAssessors.filter("" + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", Employee/FirstName)") + " or " + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", Employee/LastName)") + "").expand("Employee");
                }
            },
            { name: "Search", kind: "local", type: String }
        ], [
        ...
        BrowseRiskTypes: $defineScreen(BrowseRiskTypes, [
            {
                ...
                createQuery: function (Search) {
                    return this.dataWorkspace.ApplicationData.RiskTypes.filter("" + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", TypeOfRisk)") + "");
                }
            },
            { name: "Search", kind: "local", type: String }
        ], [
